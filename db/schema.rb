...
ActiveRecord::Schema[7.0].define(version: 2022_06_09_074829) do
  ...
  create_table "wallet_criptos", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "nombre"
    t.string "valor"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
