...
class UsuariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usuario" do
    assert_difference("Usuario.count") do
      post usuarios_url, params: { usuario: { info: @usuario.info, name: @usuario.name, team: @usuario.team } }
    end
  ...
  test "should update usuario" do
    patch usuario_url(@usuario), params: { usuario: { info: @usuario.info, name: @usuario.name, team: @usuario.team } }
